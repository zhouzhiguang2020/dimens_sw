    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!mHasInit) {
            ...
            if (null != mKeyboardListener) {
                mKeyboardListener.onKeyBoardStateChanged(ChatInputView.KEYBOARD_STATE_INIT);
            }
        } else {
            if (null != mKeyboardListener) {
                mKeyboardListener.onKeyBoardStateChanged(ChatInputView.KEYBOARD_STATE_INIT);
        ...
        if (mHasInit && mHeight > b) {
            mHasKeyboard = true;
            if (null != mKeyboardListener) {
                mKeyboardListener.onKeyBoardStateChanged(ChatInputView.KEYBOARD_STATE_SHOW);
            }
        }
        if (mHasInit && mHasKeyboard && mHeight == b) {
            mHasKeyboard = false;
            if (null != mKeyboardListener) {
                mKeyboardListener.onKeyBoardStateChanged(ChatInputView.KEYBOARD_STATE_HIDE);
            }
        }
    }
